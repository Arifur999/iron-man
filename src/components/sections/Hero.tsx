...
export function Hero() {
  ...
  return (
    <section ref={sectionRef} className="scroll-animation relative">
      <div
        className="sticky top-0 min-h-dvh w-full overflow-hidden bg-background"
      ...
      >
        ...
        >
          ...
          <h2 className="font-sans font-semibold leading-[0.88] tracking-tighter text-foreground text-[clamp(4rem,9.5vw,9rem)]">
            Build
            <br />
            with <span className="text-accent">Arif</span>
          </h2>
        ...
        {DIALOGUES.map((d) => {
          ...
          return (
            <div
              key={d.id}
              className={`pointer-events-none absolute ${position} z-20 hidden w-105 max-w-[90vw] md:block`}
            >
              <figure
